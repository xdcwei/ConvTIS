...
with tf.device('/cpu:0'):
    ...
    path = 'D:\\tis/train1_22atg6shift/'
    test_path = 'D:\\tis/test1_22atg6shift/'
    ...
    drop4 = tf.layers.dropout(dense1, 0.3)
    ...
    print(pred)
    np.savetxt("pred1_2.csv", pred, delimiter=",")
    np.savetxt("test_label1_2.csv", test_label, delimiter=",")
    sess.close()
